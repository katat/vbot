...
class VBot extends EventEmitter {
  ...
  async runSchema (schema) {
    schema.scenarios.forEach(async (scenario) => {
      ...
      let disableAnimation = 'var jQuery = window.jQuery;' +
      'if ( jQuery ) {' +
        'jQuery.fx.off = true;' +
      '}' +
      ...
      'css.type = "text/css";' +
      'css.innerHTML = "* { -webkit-transition: none !important; transition: none !important; transform: none !important; transition-duration: .0s !important; -webkit-animation: none !important; animation: none !important; }";' +
